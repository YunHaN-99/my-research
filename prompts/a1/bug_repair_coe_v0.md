...
4. 后续所有 A1 bug-repair CoE run 必须使用以下固定标题。
...
评估落地：
1. 严格按 report/a1_bug_repair_protocol_v0.md 执行。
2. 结果记录到对应 run 文档。
3. 指标写入 metrics/a1_failure_repair_eval_v0.csv。
