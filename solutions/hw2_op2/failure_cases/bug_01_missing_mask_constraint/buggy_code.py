...
# Assume helper functions are available from the surrounding chapter5 module:
# fill_missing_with_mean, iter_patch_positions, find_similar_patches,
# stack_patches, unstack_patches, insert_patch, rslt_patch_rpca, compute_metrics.
def rslt_inpainting_buggy(
    ...
    for _ in range(outer_iter):
        ...
        # BUG: forgot to restore observed pixels after aggregation.
