...
OUTPUT_DIR = os.path.join(ROOT_DIR, 'outputs', 'hw2_op2', 'run_057_coe_guided_fresh_generation')
...
def main():
    ...
    payload = {'run_id': '2026-04-12_run_057', 'mode': 'coe_guided', 'track': 'fresh_generation', 'eval_runtime_s': time.time() - eval_start, 'records': records}
