...
- Symptom restatement: the failure case shows that forgot to restore observed pixels after aggregation.
...
- Main error: forgot to restore observed pixels after aggregation.
