...
- Symptom restatement: the failure case shows that the code wrote back sparse residual patches instead of low-rank reconstruction.
...
- Main error: the code wrote back sparse residual patches instead of low-rank reconstruction.
