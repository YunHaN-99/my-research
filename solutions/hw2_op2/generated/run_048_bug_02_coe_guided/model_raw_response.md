...
- Symptom restatement: the failure case shows that mask semantics were inverted so missing pixels were treated as observed.
...
- Main error: mask semantics were inverted so missing pixels were treated as observed.
