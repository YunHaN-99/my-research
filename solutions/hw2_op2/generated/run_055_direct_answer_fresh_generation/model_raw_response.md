...
Below is a fresh direct implementation of the A2 chapter5 task. The code keeps the scope narrow: patch-group RPCA for grayscale masked inpainting under the fixed protocol.
```python
import os
import sys
...
This fresh artifact preserves the known-pixel mask constraint, patch-group RPCA, weighted patch aggregation, and the fixed-protocol evaluation path.