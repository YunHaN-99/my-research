...
OUTPUT_DIR = os.path.join(ROOT_DIR, 'outputs', 'hw2_op2', 'run_056_plain_guidance_fresh_generation')
...
def main():
    ...
    payload = {'run_id': '2026-04-12_run_056', 'mode': 'plain_guidance', 'track': 'fresh_generation', 'eval_runtime_s': time.time() - eval_start, 'records': records}
